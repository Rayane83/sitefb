-- Nettoyer et optimiser la configuration Supabase (version corrigée)
...
-- 2. Ajouter les tables manquantes à la publication realtime (ignorer les erreurs si déjà présentes)
DO $$
BEGIN
    BEGIN
        ALTER PUBLICATION supabase_realtime ADD TABLE public.dotation_reports;
    EXCEPTION WHEN duplicate_object THEN
        NULL; -- Ignorer si déjà présent
    END;
...
-- 4. Ajouter les triggers updated_at manquants
DO $$
BEGIN
